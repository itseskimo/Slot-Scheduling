...
import { setPopUpVisibility , resetDoctorsData} from '../../redux/features/doctor/doctorSlice';
const Popup = () => {
            ...
            <section className='fixed top-[50%] left-[50%]  -translate-y-[50%] -translate-x-[50%]  z-50 flex items-center justify-center w-full h-full   bg-dashoverlay shadow-xl overflow-hidden' >
                <div style={{
                   ...
                   <div className='flex items-center justify-between'>
                    ...
                    <svg onClick={()=>[dispatch(setPopUpVisibility(false)),      dispatch(resetDoctorsData())]} className='cursor-pointer' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {!isBooked ?
                        <>
                          <h6> {doctorsData.length === 0 ? 'Sorry No Doctors available currently in the city' : `Here are the available doctors in ${doctorsData[0]?.city}` } </h6>
